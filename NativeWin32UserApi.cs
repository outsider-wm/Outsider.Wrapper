...
public static class NativeWin32UserApiMethods
{
    ...
    [return: MarshalAs(UnmanagedType.Bool)]
    [DllImport("user32.dll", SetLastError = true)]
    internal static extern bool GetWindowInfo(IntPtr handle, ref NativeWin32UserApiStructs.WindowInfo pwi);

    [DllImport("user32.dll")]
    internal static extern bool GetMonitorInfo(IntPtr hMonitor, ref NativeWin32UserApiStructs.MonitorInfoEx lpmi);

    [DllImport("user32.dll")]
    internal static extern IntPtr MonitorFromWindow(IntPtr hwnd, uint dwFlags);
}

public static class NativeWin32UserApiStructs
{
    ...
    /// <summary>
    /// http://pinvoke.net/default.aspx/Enums/WindowStylesEx.html
